...
export default function Home() {
  ...
  const [removeLiquidityModalVisible, setRemoveLiquidityModalVisible] =
    React.useState(false);
  ...
  const TokenGroupDatas = {
    ...
    sources: [
      ...
      {
        src: "https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@d5c68edec1f5eaec59ac77ff2b48144679cebca1/128/color/bnb.png",
        name: "BNB",
      },
    ],
